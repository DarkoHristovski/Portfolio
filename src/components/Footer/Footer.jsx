        ...
        <footer className='section'>
            <div className='social-networks'>
                <ul>
                    ...
                    <li>
                    <a href="https://www.linkedin.com/in/darko-hristovski/" target='_blank'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather featherCodepen"><title>CodePen</title><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"></polygon><line x1="12" y1="22" x2="12" y2="15.5"></line><polyline points="22 8.5 12 15.5 2 8.5"></polyline><polyline points="2 15.5 12 8.5 22 15.5"></polyline><line x1="12" y1="2" x2="12" y2="8.5"></line></svg>  
                        </a>
                    </li>
                    <li>
                    <a href="https://www.xing.com/profile/Darko_Hristovski/web_profiles" target='_blank'>
                    <svg
...
>
  ...
  >
    ...
    />
            ...
            <p>© 2024 Darko Hristovski, All Rights Reserved.</p>
        </footer>
    )
}
