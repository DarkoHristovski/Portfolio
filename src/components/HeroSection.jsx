  ...
  const fadInHeroSection = {
    ...
    return(
        <section className="hero-section section">
          <motion.div
          variants={fadInHeroSection}
          initial="initial"
          whileInView="animate"
          viewport={{ once: true }}
          transition={{delay:1.5}}
          className="flex hero-content direction-column container">
          ...
          className="hero-section-social-networks social-networks">
        <ul>
          <li>
            <a href="https://github.com/DarkoHristovski" target="_blank" rel="noreferrer">
              <svg
          ...
          <li>
            <a href="https://codepen.io/darkoh/#" target="_blank" rel="noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                role="img"
                viewBox="0 0 24 24"
